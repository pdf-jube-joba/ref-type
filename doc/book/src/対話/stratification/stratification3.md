...
\longrightarrow^{\mathrm{tm}}_s
&\subseteq
\operatorname{Tm}^s\times\operatorname{Tm}^s
\end{aligned}
\]

- \(\mathcal S_c=\{*^c_i\mid i\in\mathbb N\}\)
- Full compatible closure: \(\operatorname{Ty}^s\)
- Full compatible closure: \(\operatorname{Tm}^s\), \(s\notin\mathcal S_c\)
- CBPV evaluation-context closure: \(\operatorname{Tm}^{*^c_i}\)
...
\{(*^v_i,*^c_j,*^c_{\max(i,j)})\}\\
&\cup
\bigcup_{\substack{q\in\{v,c\}\\i,j\in\mathbb N}}
\{(\sq^q_i,*^c_j,*^c_{\max(i+1,j)})\},\\
\mathcal R_d
={}&
\mathcal R\setminus\mathcal R_c.
\end{aligned}
\]

- \(r=(s_1,s_2,s_3)\in\mathcal R_d\)

\[
(\lambda_r x^{s_1}:A.t)@_r u
\longrightarrow^{\mathrm{tm}}_{s_2}
t[x^{s_1}:=u].
\tag{Beta}
\]
...
\[
\begin{aligned}
\operatorname{Arg}^{*^v_i}
&=\operatorname{Tm}^{*^v_i},\\
\operatorname{Arg}^{\sq^q_i}
&=
\{\operatorname{asTm}(P)\mid
  P\in\operatorname{Ty}^{*^q_i}\}.
\end{aligned}
\]

- \(r=(s_1,*^c_j,*^c_k)\in\mathcal R_c\)
- \(u\in\operatorname{Arg}^{s_1}\)

\[
(\lambda_r x^{s_1}:A.M)@_r u
\longrightarrow^{\mathrm{tm}}_{*^c_j}
M[x^{s_1}:=u].
\tag{Beta-c}
\]
...
\longrightarrow^{\mathrm{tm}}_{*^c_i} M,
\qquad
...
- \(\mathcal C^{\mathrm{ty}}[-]:
  \operatorname{Ty}^s\rightsquigarrow\operatorname{Ty}^{s'}\)

\[
\frac{A\longrightarrow^{\mathrm{ty}}_sA'}
     {\mathcal C^{\mathrm{ty}}[A]
      \longrightarrow^{\mathrm{ty}}_{s'}
      \mathcal C^{\mathrm{ty}}[A']}.
\tag{Ty-Ctx}
\]

- Non-computation term context
- \(\mathcal C^{\mathrm{ann}}[-]:
  \operatorname{Ty}^s\rightsquigarrow\operatorname{Tm}^{s'}\)
- \(\mathcal C^{\mathrm{tm}}[-]:
  \operatorname{Tm}^s\rightsquigarrow\operatorname{Tm}^{s'}\)
- \(s,s'\notin\mathcal S_c\)

\[
\frac{A\longrightarrow^{\mathrm{ty}}_sA'}
     {\mathcal C^{\mathrm{ann}}[A]
      \longrightarrow^{\mathrm{tm}}_{s'}
      \mathcal C^{\mathrm{ann}}[A']},
\qquad
\frac{
 t\longrightarrow^{\mathrm{tm}}_s t'
}{
 \mathcal C^{\mathrm{tm}}[t]
 \longrightarrow^{\mathrm{tm}}_{s'}
 \mathcal C^{\mathrm{tm}}[t']
}.
\tag{Tm-Ctx}
...
- Role / reflection payload holes: Role-Cong / Rf-Cong

- Computation evaluation context
...
- \(E[-]:
  \operatorname{Tm}^{*^c_i}\rightsquigarrow
  \operatorname{Tm}^{*^c_j}\)

\[
\frac{M\longrightarrow^{\mathrm{tm}}_{*^c_i}M'}
     {E[M]\longrightarrow^{\mathrm{tm}}_{*^c_j}E[M']}.
\tag{Comp-Ctx}
\]
...
\longrightarrow^{\mathrm{tm}}_{\kappa}t.
\tag{Role-Cancel}
\]

\[
\frac{t\longrightarrow^{\mathrm{tm}}_{\kappa}t'}
     {\operatorname{asTy}(t)
...
\frac{A\longrightarrow^{\mathrm{ty}}_sA'}
     {\operatorname{asTm}(A)
      \longrightarrow^{\mathrm{tm}}_{\uparrow(s)}
      \operatorname{asTm}(A')}.
\tag{Role-Cong}
\]
...
\frac{M\longrightarrow^{\mathrm{tm}}_{*^c_i}M'}
     {\operatorname{RfTerm}_{\underline B}(M)
      \longrightarrow^{\mathrm{tm}}_{*^s_i}
      \operatorname{RfTerm}_{\underline B}(M')}.
\tag{Rf-Cong}
\]
