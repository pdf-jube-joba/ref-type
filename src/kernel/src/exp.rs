...
pub enum Node {
    ...
    // Partial general recursion in Program.  No termination premise is part
    // of the Program typing judgement.
    Run {
        state_ty: Exp,
        result_ty: Exp,
        step: Exp,
...
/// Explicit aliases used by new APIs.  Entries are validated at the checker
/// boundary, so Set and Program judgements cannot silently consume one
/// another's assumptions.
pub type SetContext = Context;
pub type ProgramContext = Context;
