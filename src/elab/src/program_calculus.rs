...
pub fn instantiate_type_telescope(
    ...
    crate::program_definitions::instantiate_value_type(arena, ty, arguments, 0)
}
        ...
        match arena.get(term) {
            ...
            ComputationTermNode::Run {
                ...
                ComputationTermNode::Run {
                    ...
                    accessibility: crate::calculus::instantiate_at(
                        arena,
                        accessibility,
                        crate::reflection::reflect_value(env, argument)
            ...
            ComputationTermNode::RunCase {
                ...
                ComputationTermNode::RunCase {
                    ...
                    transition_equality: crate::calculus::instantiate_at(
                        arena,
                        transition_equality,
                        crate::reflection::reflect_value(env, argument)
                            .expect("checked Program value reflects"),
    ...
    loop {
        match env.arena().get(value) {
            ...
            ValueTermNode::DefinitionInstance {
                ...
                value = crate::program_definitions::instantiate_value(env, *body, &parameters, 0);
            }
            _ => break,
        }
    }
    ...
    match *node {
        ComputationTermNode::DefinitionInstance {
            ...
            match env.definition(definition) {
                DefinedConstant::ProgramComputation { body, .. } => Some(
                    crate::program_definitions::instantiate_computation(env, *body, &parameters, 0),
                ),
                _ => None,
            }
        }
        ...
        ComputationTermNode::Run {
            ...
            let transition_equality =
                arena.alloc(crate::exp::ExpNode::Prove(crate::exp::Prove::IdRefl {
                    element: crate::reflection::reflect_computation(env, transition).ok()?,
                }));
            ...
            match arena.get(unfold_value(env, value)) {
                ValueTermNode::Continue { next, .. } => {
                    Some(arena.alloc(ComputationTermNode::Run {
                        ...
                        step,
                        initial: next,
                        accessibility: arena.alloc(crate::exp::ExpNode::Prove(
                            crate::exp::Prove::AccDescent {
                                state_ty:
                                    crate::reflection::reflect_value_type(env, state_ty).ok()?,
                                result_ty:
                                    crate::reflection::reflect_value_type(env, result_ty).ok()?,
                                step: crate::reflection::reflect_value(env, step).ok()?,
                                from: crate::reflection::reflect_value(env, initial).ok()?,
                                to: crate::reflection::reflect_value(env, next).ok()?,
                                accessibility,
...
fn remap_program_arguments(
    ...
    definitions: &HashMap<DefId, DefId>,
    inductives: &HashMap<ProgramInductiveId, ProgramInductiveId>,
    logical_inductives: &HashMap<crate::ids::InductiveId, crate::ids::InductiveId>,
) -> Vec<ProgramArgument> {
    arguments
        .into_iter()
    ...
    match arena.get(computation) {
        ...
        ComputationTermNode::Run {
            ...
            ComputationTermNode::Run {
                ...
                accessibility: crate::calculus::remap_all_global_ids(
                    arena,
                    accessibility,
                    definitions,
                    logical_inductives,
        ...
        ComputationTermNode::RunCase {
            ...
            ComputationTermNode::RunCase {
                ...
                transition_equality: crate::calculus::remap_all_global_ids(
                    arena,
                    transition_equality,
                    definitions,
                    logical_inductives,
...
pub fn subst_value_module_params(
    ...
    value: ValueTerm,
    substitutions: &[(ModuleParamId, ModuleArgument)],
    reflected_substitutions: &[(ModuleParamId, crate::exp::Exp)],
) -> ValueTerm {
