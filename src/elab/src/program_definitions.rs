        ...
        match arena.get(term) {
            ...
            ComputationTermNode::Run {
                ...
                ComputationTermNode::Run {
                    ...
                    accessibility: crate::calculus::instantiate_outer_telescope(
                        arena,
                        accessibility,
                        &arguments
                            .iter()
                            .map(|ty| {
                                crate::reflection::reflect_value_type(env, *ty)
            ...
            ComputationTermNode::RunCase {
                ...
                ComputationTermNode::RunCase {
                    ...
                    transition_equality: crate::calculus::instantiate_outer_telescope(
                        arena,
                        transition_equality,
                        &arguments
                            .iter()
