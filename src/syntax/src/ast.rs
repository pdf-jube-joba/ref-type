...
use raw::exp::{Exp, ExpNode};
use raw::ids::{DefId, InductiveId, ModuleId};
use raw::sort::Sort;
...
pub struct ModItemProgramInductive {
    ...
    pub type_name: Identifier,
    pub ctor_names: Vec<Identifier>,
    pub inductive: raw::ids::ProgramInductiveId,
